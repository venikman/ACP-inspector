...
# ACP CLI Demo Script
# This script demonstrates all 5 commands of the acp-cli tool
...
if [ ! -f "$DEMO_DIR/demo-session.jsonl" ]; then
    ...
    echo "Please run this script from the examples/cli-demo directory"
    exit 1
fi
...
echo "  • Documentation: $PROJECT_ROOT/docs/tooling/acp-sentinel.md"
