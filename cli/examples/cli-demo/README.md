...
This example demonstrates all 5 commands of the `acp-inspector` tool with a realistic ACP session.
...
my-acp-consumer | dotnet run --project ../../apps/ACP.Cli -- validate --direction c2a
...
# Validate the trace
if dotnet run --project cli/apps/ACP.Cli -- inspect trace.jsonl; then
...
**Solution**: Run commands from the `cli/examples/cli-demo/` directory
...
- [Tooling Documentation](../../../docs/tooling/acp-inspector.md)
- [SDK Examples](../../../runtime/examples/README.md)
