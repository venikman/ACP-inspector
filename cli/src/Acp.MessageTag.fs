...
module MessageTag =
    ...
    let render (msg: Message) =
        ...
        | Message.FromAgent a ->
            ...
            | AgentToClientMessage.LogoutResult _ -> "logout (result)"
            ...
            | AgentToClientMessage.SessionResumeResult _ -> "session/resume (result)"
            | AgentToClientMessage.SessionCloseResult _ -> "session/close (result)"
            | AgentToClientMessage.SessionDeleteResult _ -> "session/delete (result)"
            ...
            | AgentToClientMessage.LogoutError _ -> "logout (error)"
            ...
            | AgentToClientMessage.SessionResumeError _ -> "session/resume (error)"
            | AgentToClientMessage.SessionCloseError _ -> "session/close (error)"
            | AgentToClientMessage.SessionDeleteError _ -> "session/delete (error)"
