...
- Record: `dotnet run --project apps/ACP.Inspector/ACP.Inspector.fsproj -- proxy-stdio --client-cmd "<client>" --agent-cmd "<agent>" --record tests/traces/my-trace.jsonl`
- Replay locally: `dotnet run --project apps/ACP.Inspector/ACP.Inspector.fsproj -- replay --trace tests/traces/my-trace.jsonl`
