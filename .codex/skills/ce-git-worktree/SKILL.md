...
bash .codex/skills/ce-git-worktree/scripts/worktree-manager.sh create feature-name
...
bash .codex/skills/ce-git-worktree/scripts/worktree-manager.sh create feature-login

# List all worktrees
bash .codex/skills/ce-git-worktree/scripts/worktree-manager.sh list

# Switch to a worktree
bash .codex/skills/ce-git-worktree/scripts/worktree-manager.sh switch feature-login

# Copy .env files to an existing worktree (if they weren't copied)
bash .codex/skills/ce-git-worktree/scripts/worktree-manager.sh copy-env feature-login

# Clean up completed worktrees
bash .codex/skills/ce-git-worktree/scripts/worktree-manager.sh cleanup
```
...
bash .codex/skills/ce-git-worktree/scripts/worktree-manager.sh create pr-123-feature-name
...
bash .codex/skills/ce-git-worktree/scripts/worktree-manager.sh create feature-notifications
...
```bash
bash .codex/skills/ce-git-worktree/scripts/worktree-manager.sh copy-env feature-name
```
