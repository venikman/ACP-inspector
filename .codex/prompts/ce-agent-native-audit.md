...
Use the $ce-agent-native-audit skill for this command and follow its instructions.
...
```
/prompts:compound-engineering-agent-native-architecture
```
...
1. Check for these 7 discovery mechanisms:
   ...
   - Slash commands (/prompts:help, /prompts:tools)
