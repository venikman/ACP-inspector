...
Use the $ce-changelog skill for this command and follow its instructions.
...
DISCORD_WEBHOOK_URL="https://prompts:discord.com/api/webhooks/YOUR_WEBHOOK_ID/YOUR_WEBHOOK_TOKEN"
