...
Use the $ce-test-browser skill for this command and follow its instructions.
...
Then run `/prompts:ce-test-browser` again.
```
...
/prompts:ce-test-browser

# Test specific PR
/prompts:ce-test-browser 847

# Test specific branch
/prompts:ce-test-browser feature/new-dashboard
```
