...
Use the $ce-report-bug skill for this command and follow its instructions.
...
---
*Reported via `/prompts:ce-report-bug` command*
```
...
Issue: https://prompts:github.com/EveryInc/compound-engineering-plugin/issues/[NUMBER]
