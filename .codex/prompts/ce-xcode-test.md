...
Use the $ce-xcode-test skill for this command and follow its instructions.
...
Then restart Claude Code and run `/prompts:ce-xcode-test` again.
```
...
/prompts:ce-xcode-test

# Test specific scheme
/prompts:ce-xcode-test MyApp-Debug

# Test after making changes
/prompts:ce-xcode-test current
```

## Integration with /prompts:ce-workflows-review

When reviewing PRs that touch iOS code, the `/prompts:ce-workflows-review` command can spawn this as a subagent:

```
Use the $ce-general-purpose skill to: "Run /prompts:ce-xcode-test for scheme [name]. Build, install on simulator, test key screens, check for crashes."
```
