...
Use the $ce-reproduce-bug skill for this command and follow its instructions.
...
```
mcp__plugin_compound-engineering_pw__browser_navigate({ url: "http://prompts:localhost-3000" })
