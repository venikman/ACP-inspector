...
**Key observation**: All ACP Inspector contexts have high mutual alignment (CL3-CL4), but significant loss when bridging to the ACP Protocol core (CL2-CL3). This reflects the gap between what the protocol currently supports and what rigorous assurance requires.
...
These terms have consistent meaning across all ACP Inspector contexts:
...
```text
urn:acp-inspector:context:assurance:v1
urn:acp-inspector:context:semantic:v1
urn:acp-inspector:context:capability:v1
urn:acp-inspector:context:evolution:v1
