...
| Coherence | 2.0 | Naming aligned across artifacts (score needs refresh) |
...
```
ACP-inspector  (repo folder)
ACP Inspector (product/README)
ACP.Inspector  (package)
acp-inspector  (tool)
```

**Status:** Naming aligned across product, package, and tool.
