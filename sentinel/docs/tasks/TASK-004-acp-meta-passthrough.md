...
### Domain Changes (`protocol/src/Acp.Domain.fs`)
...
### Codec Changes (`runtime/src/Acp.Codec.AcpJson.fs`)
...
### Connection Changes (`runtime/src/Acp.Connection.fs`)

Updated `SessionUpdateAsync` method to accept optional `meta` parameter.

### Tests Added (`sentinel/tests/Acp.Codec.Tests.fs`)
