...
**Files**: `sentinel/src/Acp.Assurance.fs`, `sentinel/tests/Acp.AssuranceTests.fs`
...
- `sentinel/src/Acp.Assurance.fs` - Add status type and decay logic
- `sentinel/tests/Acp.AssuranceTests.fs` - Add decay tests
...
**Files**: `sentinel/src/Acp.Assurance.fs`, `sentinel/src/Acp.Semantic.fs`
...
- `sentinel/src/Acp.Assurance.fs` - Add penalty function
- `sentinel/src/Acp.Semantic.fs` - Integrate with KindBridge
- `sentinel/tests/Acp.SemanticTests.fs` - Add penalty tests
...
**Files**: `sentinel/src/Acp.Assurance.fs`, new `sentinel/src/Acp.EvidenceGraph.fs`
...
- `sentinel/src/Acp.EvidenceGraph.fs` (new) - Graph structure and operations
- `sentinel/src/Acp.Assurance.fs` - Integrate with Reliability type
- `sentinel/tests/Acp.EvidenceGraphTests.fs` (new) - Graph tests
...
**Files**: `sentinel/src/Acp.Semantic.fs`, `sentinel/src/Acp.Validation.fs`
...
- `sentinel/src/Acp.Semantic.fs` - Add boundary checks
- `sentinel/src/Acp.Validation.fs` - Integrate into validation lanes
- `sentinel/tests/Acp.SemanticTests.fs` - Add boundary tests
...
**Files**: New `docs/fpf/drr/DRR-005-agent-tool-coordination.md`
...
- `docs/fpf/drr/DRR-005-agent-tool-coordination.md` (new)
...
**Files**: New `sentinel/src/Acp.Episteme.fs`
