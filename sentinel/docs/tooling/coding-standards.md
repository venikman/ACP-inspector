...
```text
protocol/src/               # Core protocol types + state machine
runtime/src/                # Transports, codec, runtime helpers
sentinel/src/               # Validation, assurance, runtime adapter
cli/src/                    # CLI shared code
cli/apps/                   # CLI entrypoints
```
