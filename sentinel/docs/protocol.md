...
- Domain model: `protocol/src/Acp.Domain.fs`
- Protocol state machine: `protocol/src/Acp.Protocol.fs`
- Codec: `runtime/src/Acp.Codec.fs`
- Validation/sentinel: `sentinel/src/Acp.Validation.fs`
- Runtime boundary: `sentinel/src/Acp.RuntimeAdapter.fs`
...
- ACP schema target: `Acp.Domain.Spec.Schema` (see `protocol/src/Acp.Domain.fs`)
