module Acp.Tests.DomainModelTests
...
/// - Domain invariants
///
/// Moved from sentinel/tests/Epistemology.Harness/DomainModelTests.fs
/// when the three placeholder Harness projects (SDK, Validation,
/// Epistemology) were consolidated into the main ACP.Tests suite.
