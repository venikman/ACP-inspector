...
- Treat the public ACP spec as normative
  - The published ACP schema and docs are the source of truth:
...
- ACP = Agent Client Protocol – a JSON-RPC-based protocol that standardises communication between code editors/IDEs and AI coding agents.
  - Spec source of truth (GitHub): https://github.com/agentclientprotocol/agent-client-protocol
  - Overview/intro (website): https://agentclientprotocol.com/overview/introduction
...
Protocol correctness is the primary goal; sentinel/inspector is where ACP-sentinel adds assurance and observability on top.
