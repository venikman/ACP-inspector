...
**Files**: `docs/contexts/*.md`, `src/Acp.Semantic.fs`
...
contextId: "urn:acp-sentinel:context:assurance:v1"
scope: "Trust reasoning over agent protocol messages"

// src/Acp.Semantic.fs:17-23
...
**Files**: `src/Acp.Assurance.fs:131-153`
...
**Files**: `docs/contexts/BC-001-assurance.md:92-105`, `src/Acp.Assurance.fs:159-175`
...
**Files**: `docs/contexts/BC-001-assurance.md`, `docs/drr/DRR-001*.md`, `src/Acp.Assurance.fs`
...
```fsharp
// src/Acp.Assurance.fs:14-27 (Formality F0..F9)
type Formality = F0 | F1 | ... | F9

// src/Acp.Assurance.fs:61-66 (Assurance Levels L0..L2)
type AssuranceLevel = L0 | L1 | L2

// src/Acp.Assurance.fs:142-153 (ClaimScope = G)
type ClaimScope = { slices: ContextSlice list }

// src/Acp.Assurance.fs:178-183 (Reliability = R)
type Reliability =
...
**Our Implementation**: Exact match in `src/Acp.Assurance.fs:61-66`
...
**Files**: `docs/contexts/BC-001*.md`, `src/Acp.Assurance.fs`
...
**Files**: `src/Acp.Semantic.fs:122-173`, `docs/contexts/README.md`
...
// docs/contexts/README.md Bridge Matrix:
...
| ----------- | ------ | -------------- | --------- | ----- |
| **A.1.1** U.BoundedContext | ✅ Full | `docs/contexts/BC-*` | 95% | 4 contexts defined |
