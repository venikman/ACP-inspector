...
3. **Split Acp.Codec.fs** (3130 lines → ~600 lines each)
   - Requires careful testing, affects protocol layer

### Long-Term Improvements

4. **Improve doc coverage** to >50%
5. **Add code coverage** tooling to CI
6. **Implement Epistemology.Harness** tests or archive the project
