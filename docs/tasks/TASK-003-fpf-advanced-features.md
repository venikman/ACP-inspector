...
- `src/Acp.Episteme.fs` (new module, ~250 lines)
- `tests/Acp.EpistemeTests.fs` (new tests, ~200 lines)
...
- `src/Acp.ToolPlanning.fs` (new module, ~300 lines)
- `src/Acp.Validation.fs` (add ValidationFinding variants)
- `tests/Acp.ToolPlanningTests.fs` (new tests, ~250 lines)
...
4. **Testing & Examples** (1 day)
   ...
   - Validation tests
   - Example plans in `examples/tool-planning/`
...
- `src/Acp.Evolution.fs` (expand existing stub, ~300 lines)
- `tests/Acp.EvolutionTests.fs` (expand existing stub, ~200 lines)
...
- `src/Acp.Characteristic.fs` (new framework, ~400 lines)
- `tests/Acp.CharacteristicTests.fs` (new tests, ~300 lines)
