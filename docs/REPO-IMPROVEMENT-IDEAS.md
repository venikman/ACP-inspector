...
| README: ACP-sentinel | → ACP Inspector |
| Package: ACP.Sentinel | → ACP.Inspector |
| CLI: acp-cli | → acp-inspector |
...
dotnet run --project apps/ACP.Cli -- inspect your-trace.jsonl

# Pipe agent output through validator
your-agent | dotnet run --project apps/ACP.Cli -- validate --direction a2c
```
