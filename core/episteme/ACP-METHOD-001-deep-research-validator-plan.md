...
- This is **not** part of slice‑01 (protocol spec parity). Treat as post‑slice‑01 eval/assurance work until protocol completeness is achieved.
...
- State: Exploration (post‑slice‑01).
- Promote to roadmap only after slice‑01 protocol parity is achieved and schemas + golden tests exist.
